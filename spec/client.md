...
- `cwd` defaults to the client's current directory. The same-path mount contract (see `ctl.md` Mounts) makes it valid inside the container; anything not mounted is invisible.
